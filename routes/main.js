...
var transporter = nodemailer.createTransport({
  service: 'gmail',
    auth: {
      user: 'advance.mathematics1@gmail.com',
      pass: 'uphajaaphqjbfsbx'
    }
  });
...
router.post('/registerdata',function(req,res){
    ...
    conn.query(sql, data, (error, results, fields) => {
        ...
        if (is_registerd!='Yes')
        {
          ...
          {
            var mailOptions = {
              from: 'advance.mathematics1@gmail.com',
              to: email,
...
router.post('/otpverify', (req, res) => {
    ...
    if (otp==rand) 
    {
        var record= {aadharno:data,Account_address: account_address, Is_registered : 'Yes' };
